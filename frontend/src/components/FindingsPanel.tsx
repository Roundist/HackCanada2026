...
import type { AgentInfo, GeopoliticalAlert, SystemEvent } from "../types";
...
export default function FindingsPanel({ agents, pipelineDone, geopoliticalAlerts = [], systemEvents = [] }: FindingsPanelProps) {
